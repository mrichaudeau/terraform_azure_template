# Development Environment Configuration for FastAPI with SQL and NoSQL
terraform {
  ...
  backend "azurerm" {
    ...
    # storage_account_name = "stterraformstatedev<suffix>"
...
module "data" {
  ...
  cosmos_container_throughput = 400
...
module "monitoring" {
  ...
  # Alert configurations for dev (less sensitive)
  cpu_alert_threshold         = 90
  memory_alert_threshold      = 90
  response_time_alert_threshold = 10
  sql_dtu_alert_threshold     = 90
  cosmos_ru_alert_threshold   = 2000
